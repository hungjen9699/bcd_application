      ...
      child: Row(
        ...
        children: [
          ...
          AnimatedContainer(
            ...
            child: widget._animatedWidth==30&&widget.isCart==false?Checkbox(value: checkBox,
              onChanged: (bool value) {
                setState(() {
                  this.checkBox = value;
                });
              },
            ):widget.isCart==true&&widget._animatedWidth==30?Icon(Icons.delete_outlined,color: Colors.redAccent,):Container(),
          )
        ],
      ),
    );
